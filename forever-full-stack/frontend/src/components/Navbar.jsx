    ...
    <div className='flex items-center justify-between py-5 font-medium relative'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <button
          ...
          className='hidden sm:block border border-gray-300 px-4 py-2 text-xs text-gray-700 hover:border-black hover:text-black'
        >
          TRACK ORDER
        </button>
      ...
      <div
        className={`
          fixed top-0 right-0 bottom-0 bg-white z-50
          transition-transform duration-300 ease-in-out
          ${visible ? "translate-x-0 w-full" : "translate-x-full w-full"}
        `}
      >
        <div className='flex flex-col text-gray-600'>
          ...
          <NavLink onClick={() => setVisible(false)} className='py-3 pl-6 border-b' to='/track-order'>TRACK ORDER</NavLink>
